...
class Query_users {
    ...
    public function update_the_query(){
    // public function update_the_query($id, $name, $lastname, $phone_number, $email){    
        self::query("UPDATE `author` SET `name`='Андрей',`lastname`='Бобков',`phone_number`='89768580000',`email`='andreibobkov@yandex.ru' WHERE `id` = '42';");
    }
